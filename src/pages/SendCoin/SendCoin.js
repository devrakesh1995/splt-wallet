        ...
        <View style={{ width: width, height: height - 55, backgroundColor: '#fff', }}>
          <View style={{ flex: 1, }} >
            ...
            <View style={{ height: 50, paddingHorizontal: 20, width: '100%', flexDirection: 'row', alignItems: 'center', elevation: 8, backgroundColor: '#1e3a8a' }}>
              ...
              <Text style={{ fontSize: 20, marginLeft: 10, color: '#FFF', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}>Send  Coin</Text>
            </View>

            <View style={{ marginHorizontal: 22, }}>
              <Text style={{ fontSize: 22, marginTop: 18, color: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}>Send</Text>
            </View>

            <View style={{ backgroundColor: '#F6F6F6', alignSelf: 'center', width: width - 40, borderRadius: 12, marginHorizontal: 19, elevation: 8, borderWidth: 1, borderColor: 'lightgray', marginTop: 18 }}>
              <View style={{ borderRadius: 11, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ marginHorizontal: 18, width: '100%', marginBottom: 10 }}>
                  <Text style={{ fontSize: 14, textAlign: 'left', marginTop: 10, marginLeft: 15, textShadowRadius: 1, color: '#000', textShadowColor: 'white' }}>Send Coin</Text>
                </View>
                ...
                {users && !users.sendCoinTXOTPSuccess ?
                  <>
                    <View style={{ marginHorizontal: 18, width: '100%' }}>
                      <View style={{ flexDirection: 'row', marginTop: 10, marginHorizontal: 20, justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text style={{ fontSize: 18, textAlign: 'left', marginLeft: 10, textShadowRadius: 1, color: '#000', textShadowColor: 'white' }}>To</Text>
                      ...
                      <View style={{ borderWidth: 1, borderColor: '#1E90FF', borderRadius: 11, marginHorizontal: 20, marginBottom: 30, marginTop: 40, elevation: 8 }}>
                        <View style={{ backgroundColor: '#1E90FF', height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', }}>

                          <TouchableOpacity style={{ width: '100%' }}
                            onPress={() => this.sendFrom()}>
                            <Text style={{ fontSize: 18, color: 'white', textAlign: 'center', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}> Send </Text>
                          </TouchableOpacity>
                        </View>
                      </View>
                    </View>
                  ...
                  <>
                    ...
                    <View style={{ width: width - 100, borderRadius: 11, marginHorizontal: 20, marginBottom: 30, marginTop: 40, elevation: 8 }}>
                      <View
                        style={{ backgroundColor: '#1E90FF', height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#1E90FF' }}>
                        <TouchableOpacity style={{ width: '100%' }}
