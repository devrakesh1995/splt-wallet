  ...
  render() {
    ...
    return (
      ...
      <SafeAreaView >
        ...
        <View style={{ width: width, height: height - 55, backgroundColor: '#ffff', }}>
          <View style={{ flex: 1,  }} >
            ...
            <View style={{ height: 50, paddingHorizontal: 20, width: '100%', flexDirection: 'row', alignItems: 'center', elevation: 8, backgroundColor: '#1e3a8a' }}>
              ...
              <View style={{ flexDirection: 'row', width: '95%', justifyContent: 'space-between', alignItems: 'center' }}>
                <Text style={{ fontSize: 20, marginLeft: 10, color: 'black', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}>Splt</Text>
                <TouchableOpacity onPress={this.toggleModal}
                  style={{ height: 26, width: 26, backgroundColor: '#FFD218', borderRadius: 13, alignItems: 'center', justifyContent: 'center', elevation: 8 }}>
            ...
            >
              {
                addressList && addressList.length ? addressList.map((element) => (
                  <View style={{ marginHorizontal: 18 }} key={element.id}>
                    <View style={{ backgroundColor: 'white', width:'100%', borderRadius: 13, elevation: 8, borderWidth: 1, borderColor: 'lightgray', marginTop: 15 }}>
                      <View style={{ borderRadius: 12, borderWidth: 1, borderColor: 'lightgray' }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, alignItems: 'center', marginHorizontal: 15 }}>
                          <Text style={{ fontSize: 12, fontWeight: 'bold', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}>{element.name}</Text>

                          <TouchableOpacity onPress={() => this.toggleSendModel(element)}
                          >
                            <View
                              style={{ backgroundColor: '#1E90FF', height: 20, borderRadius: 5, alignItems: 'center', justifyContent: 'center', elevation: 8 }}>
                              <Text style={{
                                marginHorizontal: 10,
                                textAlign: 'center',
                                color: '#fff',
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10, alignItems: 'center', marginHorizontal: 15, marginBottom: 10 }}>
                          <View style={{ flexDirection: 'row' }}>
                            <Text style={{ fontSize: 12, fontWeight: 'bold', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}> Address: </Text>
        ...
        <Modal isVisible={this.state.isShowModal}>
          ...
          <View style={{ alignItems: 'center' }}>
            ...
            <View style={{ backgroundColor: '#fff', width: width - 50, borderRadius: 18, elevation: 8, borderWidth: 1, borderColor: 'lightgray' }}>
              <View style={{ borderRadius: 17, borderWidth: 1, borderColor: 'lightgray' }}>

                <View style={{ marginHorizontal: 20, height: 45, backgroundColor: 'lightgray', marginTop: 30, borderRadius: 10 }}>
                  <TextInput
                ...
                <View style={{ marginHorizontal: 20, height: 45, backgroundColor: 'lightgray', marginTop: 20, borderRadius: 10 }}>
                  <TextInput
                    style={{ marginHorizontal: 10, fontSize: 15 }}
                    placeholder="Address"
                    name="address"
                ...
                <View style={{ flexDirection: 'row', marginBottom: 30, marginTop: 40, justifyContent: 'space-between', marginHorizontal: 20 }}>
                  ...
                  <View style={{ borderWidth: 1, borderColor: 'lightgray', width: '45%', borderRadius: 11, elevation: 8 }}>
        ...
        <Modal isVisible={this.state.isShowSendModal}>
          <View style={{ backgroundColor: 'white', width: width - 50, borderRadius: 12, marginHorizontal: 19, elevation: 8, borderWidth: 1, borderColor: 'lightgray', marginTop: 25 }}>
            <View style={{ borderRadius: 11, borderWidth: 1, borderColor: 'lightgray', justifyContent: 'center', alignItems: 'center' }}>
                ...
                users && !users.sendCoinTXOTPSuccess ?
                  <>
                    <View style={{ marginHorizontal: 18, width: '100%' }}>
                      <View style={{ flexDirection: 'row', marginTop: 10, marginHorizontal: 20, justifyContent: 'space-between', alignItems: 'center' }}>
                        <Text style={{ fontSize: 18, fontWeight: 'normal', color: '#000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 1, textShadowColor: 'lightgray' }}>
                      ...
                      <View style={{ marginHorizontal: 20, height: 45, backgroundColor: 'lightgray', marginTop: 15, borderRadius: 10 }}>
                        <TextInput
                          style={{ marginHorizontal: 10, fontSize: 15 }}
                          placeholder="Amount"
                          name="amount"
                  ...
                  <>
                    ...
                    <View style={{ borderWidth: 1, borderColor: '#131313', width: width - 100, borderRadius: 11, marginHorizontal: 20, marginBottom: 30, marginTop: 40, elevation: 8 }}>
                      ...
                      <View
                        style={{ backgroundColor: 'red', height: 40, borderRadius: 10, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#C79323' }}>
                        <TouchableOpacity style={{ width: '100%' }}
